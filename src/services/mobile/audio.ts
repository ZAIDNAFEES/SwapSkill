 ...
 * during WebRTC audio/video calls.
 */
...
export class MobileAudioRoutingService {
  ...
  /**
   * Resets audio route to default phone/system device
   */
  public async resetAudioRouting(audioElement?: HTMLAudioElement | null): Promise<void> {
    await this.setAudioRoute("default", audioElement);
  }
